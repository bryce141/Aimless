...
- **The Notes field holds about 3,300 characters, not the 4,000 documented
  elsewhere.** The first draft was 3,917 and App Store Connect rejected it as
  607 over, which is where that number comes from. The block below is 3,162,
  leaving a little room. Re-count before pasting an expanded version.
